...
const DANCES = [
  ...
  new Dance({
    ...
    positions: [
      new DancePosition({ order: 1, tag: "9", positionType: new PositionType({ label: "ANTIHORARI/PRIMER DALT" }), specifications: "Cantó equerre/cara plaça" }),
      new DancePosition({ order: 2, tag: "10", positionType: new PositionType({ label: "HORARI/PRIMER BAIX" }), specifications: "Mig equerre/cara plaça" }),
      new DancePosition({ order: 3, tag: "11", positionType: new PositionType({ label: "ANTIHORARI/SEGON DALT" }), specifications: "Mig dret/cara plaça" }),
      new DancePosition({ order: 4, tag: "12", positionType: new PositionType({ label: "HORARI/SEGON BAIX" }), specifications: "Cantó dret/cara plaça" }),
      new DancePosition({ order: 5, tag: "13", positionType: new PositionType({ label: "ANTIHORARI/SEGON DALT" }), specifications: "Cantó equerre/esquena plaça" }),
      new DancePosition({ order: 6, tag: "14", positionType: new PositionType({ label: "HORARI/SEGON BAIX" }), specifications: "Mig esquerre/esquena plaça" }),
      new DancePosition({ order: 7, tag: "15", positionType: new PositionType({ label: "ANTIHORARI/SEGON DALT" }), specifications: "Mig dret/esquena plaça" }),
      new DancePosition({ order: 8, tag: "16", positionType: new PositionType({ label: "HORARI/SEGON BAIX" }), specifications: "Cantó dret/esquena plaça" }),
      new DancePosition({ order: 9, tag: "8", positionType: new PositionType({ label: "HORARI/SEGON BAIX" }), specifications: "Cantó equerre/cara plaça" }),
      new DancePosition({ order: 10, tag: "7", positionType: new PositionType({ label: "ANTIHORARI/SEGON DALT" }), specifications: "Mig equerre/cara plaça" }),
      new DancePosition({ order: 11, tag: "6", positionType: new PositionType({ label: "HORARI/SEGON BAIX" }), specifications: "Mig dret/cara plaça" }),
      new DancePosition({ order: 12, tag: "5", positionType: new PositionType({ label: "ANTIHORARI/SEGON DALT" }), specifications: "Cantó dret/cara plaça" }),
      new DancePosition({ order: 13, tag: "4", positionType: new PositionType({ label: "HORARI/SEGON BAIX" }), specifications: "Cantó equerre/esquena plaça" }),
      new DancePosition({ order: 14, tag: "3", positionType: new PositionType({ label: "ANTIHORARI/SEGON DALT" }), specifications: "Mig esquerre/esquena plaça" }),
      new DancePosition({ order: 15, tag: "2", positionType: new PositionType({ label: "HORARI/SEGON BAIX" }), specifications: "Mig dret/esquena plaça" }),
      new DancePosition({ order: 16, tag: "1", positionType: new PositionType({ label: "ANTIHORARI/SEGON DALT" }), specifications: "Cantó dret/esquena plaça" }),
    ],
    audios: [
      new DanceMusic({ fileId: "1XIhGj3cylFK2velpOdpWX4bW8FHx9RaT", title: "Joan del riu - Per assajar", artist: "Reina, Josep i Quim" }),
    ],
